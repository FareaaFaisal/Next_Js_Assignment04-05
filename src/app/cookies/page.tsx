    ...
    return(
         ...
         <div className="parentContainer">  
              ...
              <div className="childContainer slide-in-top ">   {/* 1 */}
                 ...
                 <div className="imageContainer"><img src="./cookies/cookie 1.jpg" alt="Cake image" /></div>
                 <h1 className="title">Lotus Cookie</h1>
                 <p className="description">Rs. 190</p>
                 <button className="readMore">Add to Cart</button>
              ...
              <div className="childContainer slide-in-top">   {/* 2 */}
               ...
               <div className="imageContainer"><img src="./cookies/cookie 2.jpg" alt="Cake image" /></div>
              ...
              <div className="imageContainer"><img src="./cookies/cookie 3.png" alt="Cake image" /></div>
              ...
              <div className="childContainer slide-in-top">   {/* 4 */}
               ...
               <div className="imageContainer"><img src="./cookies/cookie 4.png" alt="Cake image" /></div>
              ...
              <div className="childContainer slide-in-top">   {/* 5 */}
               ...
               <div className="imageContainer"><img src="./cookies/cookie 5.png" alt="Cake image" /></div>
     ...
     <div className="imageContainer"><img src="./cookies/cookie 6.png" alt="Cake image" /></div>
